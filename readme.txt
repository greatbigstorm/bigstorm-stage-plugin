...
= 1.1.3 =
* Change: Robots.txt blocking now enabled by default (can be disabled in settings)

= 1.1.2 =
* Change: Block search crawlers from accessing robots.txt (return HTTP 410 instead)
